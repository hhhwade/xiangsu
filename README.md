...
已生成 Release 签名的原生高德地图安装包：[`travel-planner/release/xingji-smart-travel-amap-v1.2.0-release.apk`](travel-planner/release/xingji-smart-travel-amap-v1.2.0-release.apk)。它使用竖屏上路线、下高德地图的可滑动布局，高德 Search SDK 实时校准 POI 坐标与景点描述，并支持全国城市扩展、1–30 天、交通方式重算以及路线编号/地图 Marker/方向箭头同步；安装、Release SHA1、高德 Key 绑定和 ICP 分发说明见 [mobile-apk.md](travel-planner/docs/mobile-apk.md)。
