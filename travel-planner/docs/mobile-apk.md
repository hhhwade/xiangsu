...
## 已生成：Release 签名 APK v1.1.2

下载文件：

```text
travel-planner/release/xingji-smart-travel-amap-v1.1.2-release.apk
```
...
| target SDK | API 34 |
| APK SHA-256 | `dd99fcf25d7a4b0062e17d74c245904dbdd91ea93d3bf90162c50bcd79ba5d91` |
